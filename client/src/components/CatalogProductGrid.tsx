    ...
    <div className="flex-1">
      ...
      <div className="mb-7">
        <p className="text-black font-beatrice-deck text-xs font-medium tracking-wider">
          <span className="text-black/60">Home</span> / Sneakers
        </p>
      </div>
      ...
      <div className="mb-10">
        ...
        <div className="relative w-[367px] h-12 bg-gray-300 rounded-sm mb-10 flex items-center">
          ...
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-transparent pl-12 pr-4 text-black font-beatrice-deck text-xs tracking-wider placeholder:text-black/60 outline-none"
          />
        </div>
