...
export default function SneakerQuiz() {
  ...
  // --- About.html inspired wrappers ---
  // Hero Section
  const SectionHeader = (
    <section className="section bg-transparent">
      <div className="w-layout-blockcontainer container pt-8 pb-4 w-container">
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          <h1 className="font-huge" style={{ fontSize: '3.2rem', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: '0.5rem' }}>STYLE QUIZ</h1>
          <p className="max-w-xl text-lg text-muted-foreground" style={{ margin: '0 auto' }}>
            Discover your sneaker personality and get personalized recommendations with our interactive quiz.
          </p>
        </div>
      </div>
    </section>
  ...
  // Main quiz section wrapper
  const MainSection = (children: React.ReactNode) => (
    <section className="section bg-transparent">
      <div className="w-layout-blockcontainer container pt-4 pb-8 w-container">
        {children}
      </div>
    </section>
  );
