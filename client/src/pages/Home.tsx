...
const useStore = (selector: (state: { isNavigationCollapsed: boolean }) => boolean) => {
  const [collapsed, setCollapsed] = useState(false);
  
  // Simple store implementation for navigation state
  if (selector.toString().includes('isNavigationCollapsed')) {
    return collapsed;
  }
  return false;
};
    ...
    <div className="w-full bg-black text-white min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-10 text-center max-w-5xl mx-auto px-6">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            From virtual workspaces to immersive entertainment.
          </p>
      ...
      <footer className="py-20 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mb-8">Redefining reality, one experience at a time</p>
